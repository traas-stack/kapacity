...
type Horizontal interface {
	...
	GetPortraitIdentifier(ihpa *v1alpha1.IntelligentHorizontalPodAutoscaler, cfg *v1alpha1.HorizontalPortraitProvider) string
	// UpdatePortraitSpec creates or updates the portrait backend managed by given IHPA and provider config.
	UpdatePortraitSpec(ctx context.Context, ihpa *v1alpha1.IntelligentHorizontalPodAutoscaler, cfg *v1alpha1.HorizontalPortraitProvider) error
	// FetchPortraitValue fetches the current value from the data of portrait managed by given IHPA and provider config.
	FetchPortraitValue(ctx context.Context, ihpa *v1alpha1.IntelligentHorizontalPodAutoscaler, cfg *v1alpha1.HorizontalPortraitProvider) (*v1alpha1.HorizontalPortraitValue, error)
	// CleanupPortrait does clean up works for the identified portrait managed by given IHPA.
	CleanupPortrait(ctx context.Context, ihpa *v1alpha1.IntelligentHorizontalPodAutoscaler, identifier string) error
}
